...
final class MainViewController: UIViewController {
    ...
    private let statusTopic: String = "FF02/EQBTABhRNzMwODky/status/#" // Топик для статуса устройства
    private let messageTopic: String = "FF02/EQBTABhRNzMwODky/685F7B00685F7B00/api/v1/led/all/[0,5]" // Топик для сообщений
