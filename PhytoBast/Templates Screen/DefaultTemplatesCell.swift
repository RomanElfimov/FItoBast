...
final class DefaultTemplatesCell: UICollectionViewCell {

    // MARK: - Completion Handlers

    var startButtonAction: (() -> Void)? // Начать сценарий
    var favouritesButtonAction: (() -> Void)? // Добавить/удалить в избранное
    ...
    private lazy var imageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "PhotostockPlantIage")
        return imageView
    }()
